...
def result():
    ...
    url = "https://yourkotaichi.herokuapp.com/result/?"+"name="+name+"&count="+str(count)+"&h="+str(result[0])+"&"+"a="+str(
        result[1])+"&"+"b="+str(result[2])+"&"+"c="+str(result[3])+"&"+"d="+str(result[4])+"&"+"f="+str(result[5])+"&"+"chara="+result[6]
